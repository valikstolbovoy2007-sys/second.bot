...
DEFAULTS: dict[str, str] = {
    ...
    "catalog.legend": (
        "<blockquote>🔴 - завоз недавно \n"
        "🟡 - середина\n"
        "🟢 - завоз давно\n"
        "\n"
        "🚚 - сегодня день завоза\n"
        "🎩 - вещи по фиксированной цене\n"
        "💘 - добавлен в 'Ну мои' (Будут приходить уведомления перед завозами)</blockquote>"
    ),
    "catalog.empty": (
        "🛍 <b>Каталог пуст</b>\n"
        "\n"
    ...
    "catalog.nearby.prompt": (
        ...
        "от ближайшего к самому дальнему; магазины без метки на карте "
        "останутся в конце списка."
    ),
...
DESCRIPTIONS: dict[str, str] = {
    ...
    "catalog.nearby.back":    "Кнопка «Назад» на экране запроса геолокации",
...
GROUPS: list[tuple[str, str, list[str]]] = [
    ...
    ("catalog", "Каталог", [
        ...
        "catalog.nearby.button", "catalog.nearby.back", "catalog.nearby.prompt",
    ]),
